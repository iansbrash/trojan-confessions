            ...
            <div className="py-4 px-2">
                <div className="flex flex-row p-2 rounded-lg bg-gray-100 shadow-md">
                    ...
                    <div className="flex flex-1 flex-col px-3">
                        <div className="hidden xs:block -mb-3 text-left font-bold text-4xl text-gray-600">
                            {email === '' || !email.includes('@usc.edu') ? 'Tommy Trojan' : `${firstName} ${lastName}`}
                        </div>
                        <div className="block xs:hidden -mb-3 text-left font-bold text-4xl text-gray-600">
                            T. Trojan
                        </div>
